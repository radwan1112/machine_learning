...
src_folder = r"D:\study\python\machine_learning\deep learning\practicalDL\chapter3\data\images"

train_cat_dst_folder = r"D:\study\python\machine_learning\deep learning\practicalDL\chapter3\data\train\cat"
val_cat_dst_folder = r"D:\study\python\machine_learning\deep learning\practicalDL\chapter3\data\val\cat"
train_dog_dst_folder = r"D:\study\python\machine_learning\deep learning\practicalDL\chapter3\data\train\dog"
val_dog_dst_folder = r"D:\study\python\machine_learning\deep learning\practicalDL\chapter3\data\val\dog"
...
for file in glob.iglob(pattern_cat, recursive=True):
    ...
    if(no_of_train_cat_files < 250):
        shutil.move(file, train_cat_dst_folder)
        print('Moved: ', file)
    elif(no_of_val_cat_files < 250):
...
for file in glob.iglob(pattern_dog, recursive=True):
    ...
    if(no_of_train_dog_files < 250):
        shutil.move(file, train_dog_dst_folder)
        print('Moved: ', file)
    elif(no_of_val_dog_files < 250):
